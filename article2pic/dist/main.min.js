...
$(function() {
    ...
    var b = function() {
        ...
        b.author = a.find(".author").text();
        b.avatar = a.find(".author img").attr("src");
        b.date = a.find("span[itemprop=datePublished]").text();
        b.content = a.find("#article").html();
