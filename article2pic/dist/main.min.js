        ...
        1: [ function(b, c) {
            (function(b, d) {
                (function() {
                    ...
                    function I(a) {
                        this._id = ab++, this._state = void 0, this._result = void 0, this._subscribers = [], 
                    ...
                    "function" == typeof a && a.amd ? a(function() {
                        return db;
                    }) : "undefined" != typeof c && c.exports ? c.exports = db : "undefined" != typeof this && (this.ES6Promise = db);
                }).call(this);
...
$(function() {
    ...
    var b = function() {
        var b = $(".container"), c = {};
        c.title = b.find(".topic-title").text();
        c.author = b.find(".author").text();
        c.avatar = b.find(".author img").attr("src");
        c.date = b.find("span[itemprop=datePublished]").text();
        c.content = b.find("#article").html();
        $("body").append('<div id="pluginDOM"><div id="plugin-content"></div></div>');
        var d = $("#pluginDOM"), e = d.find("#plugin-content");
        ...
        f("article-date", c.date);
        f("article-author", c.author);
        f("article-content", c.content, "dom");
        e.append('<img id="article-footerimg" class="hide"></div>');
        function f(a, b, c) {
            c = c || "text";
            e.append('<div class="' + a + '"></div>');
            if (c === "text") {
                e.find("." + a).text(b);
            } else {
                e.find("." + a).html(b);
        ...
        function g(a) {
            for (var b = 0; b < a.length; b++) {
                var c = a[b], d = e.find(c.selector), f = d.attr("style"), g = c.value;
                if (f) g = f + g;
                d.attr("style", g);
            }
        }
        (function() {
            ...
            pluginTool.read("footerimg", function(a) {
                ...
                if (!$.isEmptyObject(a.footerimg)) {
                    d = $.parseJSON(a.footerimg);
                } else {
                    d = {};
                }
                for (img in d) {
                    var f = img, g = d[img], h = c.clone();
                    h.removeClass("hide");
                    h.css({
                ...
                b.find(".footerimg-item").on("click", function() {
                    var a = $(this).data("imgurl"), b = e.find("#article-footerimg");
    ...
    (function() {
        var a = chrome.extension.getURL("click_btn.html"), c = $("#plugin-content");
        $.get(a, function(a) {
            $("body").append(a);
        ...
        var d = ($(document).width() - $(".container").width()) / 2;
        $("#plugin-inject-btn").css("left", d);
    })();
    function c(a, b, c) {
        var d = document, e = arguments, f = d.createElement("a"), g = e[0], h = e[1], i = e[2] || "text/plain";
        f.href = "data:" + c + "," + escape(a);
        if (window.MSBlobBuilder) {
            var j = new MSBlobBuilder();
            j.append(a);
            return navigator.msSaveBlob(j, b);
        }
        if ("download" in f) {
        ...
        k.src = "data:" + (e[2] ? e[2] : "application/octet-stream") + (window.btoa ? ";base64" : "") + "," + (window.btoa ? window.btoa : escape)(a);
        setTimeout(function() {
