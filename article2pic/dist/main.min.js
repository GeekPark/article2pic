...
$(function() {
    ...
    (function() {
        $root = $("#article-style");
        pluginTool.read("style", function(a) {
            if (!$.isEmptyObject(a.style)) {
                var b = $.parseJSON(a.style);
                for (var c = 0; c < b.length; c++) {
                    var d = b[c];
                    var e = $root.find('li[data-selector="' + d.selector + '"]');
                    e.find("input").val(d.value);
                }
            }
        });
        $root.find("#article-style-save").on("click", function() {
            ...
            $root.find("#style-form input").each(function() {
                var b = {};
                b.selector = $(this).parents("li").eq(0).data("selector");
                b.value = $(this).val();
                a.push(b);
            });
            var b = JSON.stringify(a);
            pluginTool.save("style", b);
            location.reload();
        });
    })();
});