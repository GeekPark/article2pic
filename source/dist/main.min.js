...
$(function() {
    ...
    (function() {
        ...
        var b = ($(document).width() - $(".container").width()) / 2;
        $("#plugin-inject-btn").css("left", b);
    })();
    var a = function() {
        var a = $(".container"), b = {};
        ...
        pluginTool.read("style", function(a) {
            ...
            for (var c = 0; c < b.length; c++) {
                var e = b[c], f = d.find(e.selector), g = f.attr("style");
                f.attr("style", g + e.value);
            }
        });
        function f(a, b) {
            d.find(a).css(b);
