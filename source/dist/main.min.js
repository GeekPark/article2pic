!function(a, b) {
    ...
    var s = function(a) {
        var b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u = "sizzle" + -new Date(), v = a.document, w = 0, x = 0, y = ga(), z = ga(), A = ga(), B = function(a, b) {
            return a === b && (l = !0), 0;
        ...
        }, Y = /^(?:input|select|textarea|button)$/i, Z = /^h\d$/i, $ = /^[^{]+\{\s*\[native \w/, _ = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, aa = /[+~]/, ba = /'|\\/g, ca = new RegExp("\\\\([\\da-f]{1,6}" + M + "?|(" + M + ")|.)", "ig"), da = function(a, b, c) {
            var d = "0x" + b - 65536;
        ...
        c = fa.support = {}, f = fa.isXML = function(a) {
            ...
            }), c.getElementsByClassName = $.test(e.getElementsByClassName) && ia(function(a) {
            ...
            }, r = [], q = [], (c.qsa = $.test(e.querySelectorAll)) && (ia(function(a) {
        ...
        function va(a, b, c, d, e, f) {
            return d && !d[u] && (d = va(d)), e && !e[u] && (e = va(e, f)), ha(function(f, g, h, i) {
                ...
                } else r = ua(r === g ? r.splice(o, r.length) : r), e ? e(null, g, r, i) : I.apply(g, r);
            });
        }
        function wa(a) {
        ...
        function xa(a, b) {
            var c = b.length > 0, e = a.length > 0, f = function(f, g, h, i, k) {
                ...
                if (p += q, c && q !== p) {
                    ...
                    I.apply(i, s), k && !f && s.length > 0 && p + b.length > 1 && fa.uniqueSort(i);
                }
                return k && (w = v, j = t), r;
            };
            return c ? ha(f) : f;
            ...
            if (e = e || [], 1 === o.length) {
                ...
                while (i--) {
                    ...
                    if ((m = d.find[l]) && (f = m(k.matches[0].replace(ca, da), aa.test(j[0].type) && oa(b.parentNode) || b))) {
                        if (j.splice(i, 1), a = f.length && qa(j), !a) return I.apply(e, f), e;
                        break;
                    }
                }
            }
...
!function(a) {
    ...
    return function b(a, c, d) {
        ...
        1: [ function(b, c) {
            (function(b, d) {
                (function() {
                    ...
                    function j() {
                        var a = 0, b = new P(m), c = document.createTextNode("");
                        return b.observe(c, {
                            characterData: !0
                        }), function() {
                            c.data = a = ++a % 2;
                    ...
                    function t(a, b) {
                        b._state === T ? x(a, b._result) : a._state === U ? y(a, b._result) : z(b, void 0, function(b) {
                            v(a, b);
                        }, function(b) {
                            y(a, b);
                        });
                    ...
                    function u(a, b) {
                        if (b.constructor === a.constructor) t(a, b); else {
                            var c = q(b);
                            c === V ? y(a, V.error) : void 0 === c ? x(a, b) : f(c) ? s(a, b, c) : x(a, b);
                        }
                    }
                    function v(a, b) {
                        a === b ? y(a, o()) : e(b) ? u(a, b) : x(a, b);
                    }
                    function w(a) {
                        a._onerror && a._onerror(a._result), A(a);
                    }
                    function x(a, b) {
                        a._state === S && (a._result = b, a._state = T, 0 === a._subscribers.length || N(A, a));
                    }
                    function y(a, b) {
                        a._state === S && (a._state = U, a._result = b, N(w, a));
                    }
                    function z(a, b, c, d) {
                        var e = a._subscribers, f = e.length;
                        a._onerror = null, e[f] = b, e[f + T] = c, e[f + U] = d, 0 === f && a._state && N(A, a);
                    }
                    function A(a) {
                    ...
                    function D(a, b, c, d) {
                        var e, g, h, i, j = f(c);
                        if (j) {
                            if (e = C(c, d), e === W ? (i = !0, g = e.error, e = null) : h = !0, b === e) return void y(b, p());
                        } else e = d, h = !0;
                        b._state !== S || (j && h ? v(b, e) : i ? y(b, g) : a === T ? x(b, e) : a === U && y(b, e));
                    }
                    function E(a, b) {
                        try {
                            b(function(b) {
                    ...
                    function F(a, b, c, d) {
                        this._instanceConstructor = a, this.promise = new a(n, d), this._abortOnReject = c, 
                        this._validateInput(b) ? (this._input = b, this.length = b.length, this._remaining = b.length, 
                        this._init(), 0 === this.length ? x(this.promise, this._result) : (this.length = this.length || 0, 
                        this._enumerate(), 0 === this._remaining && x(this.promise, this._result))) : y(this.promise, this._validationError());
                    }
                    function G() {
                    ...
                    function I(a) {
                        this._id = aa++, this._state = void 0, this._result = void 0, this._subscribers = [], 
                        n !== a && (f(a) || G(), this instanceof I || H(), E(this, a));
                    }
                    var J;
                    J = Array.isArray ? Array.isArray : function(a) {
                    ...
                    var K, L = J, M = (Date.now || function() {
                        ...
                        R[M] = a, R[M + 1] = b, M += 2, 2 === M && K();
                    }, O = "undefined" != typeof window ? window : {}, P = O.MutationObserver || O.WebKitMutationObserver, Q = "undefined" != typeof Uint8ClampedArray && "undefined" != typeof importScripts && "undefined" != typeof MessageChannel, R = new Array(1e3);
                    K = "undefined" != typeof b && "[object process]" === {}.toString.call(b) ? i() : P ? j() : Q ? k() : l();
                    ...
                    F.prototype._enumerate = function() {
                        for (var a = this.length, b = this.promise, c = this._input, d = 0; b._state === S && a > d; d++) this._eachEntry(c[d], d);
                    }, F.prototype._eachEntry = function(a, b) {
                        var c = this._instanceConstructor;
                        g(a) ? a.constructor === c && a._state !== S ? (a._onerror = null, this._settledAt(a._state, b, a._result)) : this._willSettleAt(c.resolve(a), b) : (this._remaining--, 
                        this._result[b] = this._makeResult(T, b, a));
                    }, F.prototype._settledAt = function(a, b, c) {
                        var d = this.promise;
                        d._state === S && (this._remaining--, this._abortOnReject && a === U ? y(d, c) : this._result[b] = this._makeResult(a, b, c)), 
                    ...
                    var Y = function(a, b) {
                        ...
                        var e = this, f = new e(n, b);
                        if (!L(a)) return y(f, new TypeError("You must pass an array to race.")), f;
                        for (var g = a.length, h = 0; f._state === S && g > h; h++) z(e.resolve(a[h]), void 0, c, d);
                        return f;
                    }, $ = function(a, b) {
                        var c = this;
                    ...
                    I.all = Y, I.race = Z, I.resolve = $, I.reject = _, I.prototype = {
                        ...
                        then: function(a, b) {
                            ...
                            if (d === T && !a || d === U && !b) return this;
                            var e = new this.constructor(n), f = c._result;
                            if (d) {
                                var g = arguments[d - 1];
                                N(function() {
                                    D(d, e, g, f);
                    ...
                    "function" == typeof a && a.amd ? a(function() {
                        return da;
                    }) : "undefined" != typeof c && c.exports ? c.exports = da : "undefined" != typeof this && (this.ES6Promise = da);
                }).call(this);
        ...
        3: [ function(b, c, d) {
            (function(b) {
                !function(e) {
                    ...
                    function i(a) {
                        for (var b, c, d = [], e = 0, f = a.length; f > e; ) b = a.charCodeAt(e++), b >= 55296 && 56319 >= b && f > e ? (c = a.charCodeAt(e++), 
                    ...
                    function j(a) {
                        return g(a, function(a) {
                            var b = "";
                            return a > 65535 && (a -= 65536, b += L(a >>> 10 & 1023 | 55296), a = 56320 | 1023 & a), 
                            b += L(a);
                        }).join("");
                    }
                    function k(a) {
                    ...
                    function n(a) {
                        ...
                        for (c = a.lastIndexOf(E), 0 > c && (c = 0), d = 0; c > d; ++d) a.charCodeAt(d) >= 128 && f("not-basic"), 
                        p.push(a.charCodeAt(d));
                        for (e = c > 0 ? c + 1 : 0; q > e; ) {
                            for (g = r, h = 1, i = x; e >= q && f("invalid-input"), l = k(a.charCodeAt(e++)), 
                            (l >= x || l > K((w - r) / h)) && f("overflow"), r += l * h, n = t >= i ? y : i >= t + z ? z : i - t, 
                            !(n > l); i += x) o = x - n, h > K(w / o) && f("overflow"), h *= o;
                            b = p.length + 1, t = m(r - g, b, 0 == g), K(r / b) > w - s && f("overflow"), s += K(r / b), 
                            r %= b, p.splice(r++, 0, s);
                        }
                        return j(p);
                    }
                    function o(a) {
                        ...
                        for (d = e = u.length, e && u.push(E); q > d; ) {
                            ...
                            for (r = d + 1, j - b > K((w - c) / r) && f("overflow"), c += (j - b) * r, b = j, 
                            h = 0; q > h; ++h) if (p = a[h], b > p && ++c > w && f("overflow"), p == b) {
                                for (k = c, n = x; o = g >= n ? y : n >= g + z ? z : n - g, !(o > k); n += x) t = k - o, 
                                s = x - o, u.push(L(l(o + t % s, 0))), k = K(t / s);
                    ...
                    var r = "object" == typeof d && d, s = "object" == typeof c && c && c.exports == r && c, t = "object" == typeof b && b;
                    ...
                    if (u = {
                        ...
                        return u;
                    }); else if (r && !r.nodeType) if (s) s.exports = u; else for (v in u) u.hasOwnProperty(v) && (r[v] = u[v]); else e.punycode = u;
                }(this);
        ...
        4: [ function(a, b) {
            ...
            function e(a) {
                [].slice.call(a.querySelectorAll("canvas"), 0).forEach(function(a) {
                    a.setAttribute(m, "canvas-" + n++);
                });
            }
            function f(a, b) {
                [].slice.call(a.querySelectorAll("[" + m + "]"), 0).forEach(function(a) {
                    try {
                        var c = b.querySelector("[" + m + '="' + a.getAttribute(m) + '"]');
                        c && (c.width = a.width, c.height = a.height, c.getContext("2d").putImageData(a.getContext("2d").getImageData(0, 0, a.width, a.height), 0, 0));
                    } catch (d) {
                        k("Unable to copy canvas content from", a, d);
                    }
                    a.removeAttribute(m);
                });
            }
            function g(a) {
                return [].slice.call(a.childNodes, 0).filter(j).forEach(function(b) {
                    "SCRIPT" === b.tagName ? a.removeChild(b) : g(b);
                }), a;
            }
            function h() {
            ...
            function i(a, b) {
                for (var c = 3 === a.nodeType ? document.createTextNode(a.nodeValue) : a.cloneNode(!1), d = a.firstChild; d; ) (b === !0 || 1 !== d.nodeType || "SCRIPT" !== d.nodeName) && c.appendChild(i(d, b)), 
                d = d.nextSibling;
                return c;
            }
            function j(a) {
            ...
            var k = a("./log"), l = a("./promise"), m = "data-html2canvas-canvas-clone", n = 0;
            b.exports = function(a, b, j, k, m, n, o) {
                e(a);
                var p = h() ? i(a.documentElement, m.javascriptEnabled) : a.documentElement.cloneNode(!0), q = b.createElement("iframe");
                return q.className = "html2canvas-container", q.style.visibility = "hidden", q.style.position = "fixed", 
                q.style.left = "-10000px", q.style.top = "0px", q.style.border = "0", q.width = j, 
                q.height = k, q.scrolling = "no", b.body.appendChild(q), new l(function(b) {
                    var e = q.contentWindow.document;
                    c(a.documentElement, p, "textarea"), c(a.documentElement, p, "select"), q.contentWindow.onload = q.onload = function() {
                        var c = setInterval(function() {
                            e.body.childNodes.length > 0 && (f(a, e), clearInterval(c), "view" === m.type && q.contentWindow.scrollTo(n, o), 
                            b(q));
                        }, 50);
                    }, e.open(), e.write("<!DOCTYPE html><html></html>"), d(a, n, o), e.replaceChild(m.javascriptEnabled === !0 ? e.adoptNode(p) : g(e.adoptNode(p)), e.documentElement), 
                    e.close();
                });
            };
        }, {
        ...
        5: [ function(a, b) {
            ...
            c.prototype.darken = function(a) {
                var b = 1 - a;
                return new c([ Math.round(this.r * b), Math.round(this.g * b), Math.round(this.b * b), this.a ]);
            }, c.prototype.isTransparent = function() {
                return 0 === this.a;
            }, c.prototype.isBlack = function() {
                return 0 === this.r && 0 === this.g && 0 === this.b;
            }, c.prototype.fromArray = function(a) {
                return Array.isArray(a) && (this.r = Math.min(a[0], 255), this.g = Math.min(a[1], 255), 
                this.b = Math.min(a[2], 255), a.length > 3 && (this.a = a[3])), Array.isArray(a);
            };
            var d = /^#([a-f0-9]{3})$/i;
            c.prototype.hex3 = function(a) {
                var b = null;
                return null !== (b = a.match(d)) && (this.r = parseInt(b[1][0] + b[1][0], 16), this.g = parseInt(b[1][1] + b[1][1], 16), 
                this.b = parseInt(b[1][2] + b[1][2], 16)), null !== b;
            };
            var e = /^#([a-f0-9]{6})$/i;
            c.prototype.hex6 = function(a) {
                var b = null;
                return null !== (b = a.match(e)) && (this.r = parseInt(b[1].substring(0, 2), 16), 
                this.g = parseInt(b[1].substring(2, 4), 16), this.b = parseInt(b[1].substring(4, 6), 16)), 
                null !== b;
            };
            var f = /^rgb\((\d{1,3}) *, *(\d{1,3}) *, *(\d{1,3})\)$/;
            c.prototype.rgb = function(a) {
                var b = null;
                return null !== (b = a.match(f)) && (this.r = Number(b[1]), this.g = Number(b[2]), 
                this.b = Number(b[3])), null !== b;
            };
            var g = /^rgba\((\d{1,3}) *, *(\d{1,3}) *, *(\d{1,3}) *, *(\d+\.?\d*)\)$/;
            c.prototype.rgba = function(a) {
                var b = null;
                return null !== (b = a.match(g)) && (this.r = Number(b[1]), this.g = Number(b[2]), 
                this.b = Number(b[3]), this.a = Number(b[4])), null !== b;
            }, c.prototype.toString = function() {
                return null !== this.a && 1 !== this.a ? "rgba(" + [ this.r, this.g, this.b, this.a ].join(",") + ")" : "rgb(" + [ this.r, this.g, this.b ].join(",") + ")";
            }, c.prototype.namedColor = function(a) {
                var b = h[a.toLowerCase()];
                if (b) this.r = b[0], this.g = b[1], this.b = b[2]; else if ("transparent" === a.toLowerCase()) return this.r = this.g = this.b = this.a = 0, 
                !0;
                return !!b;
            }, c.prototype.isColor = !0;
            var h = {
        ...
        6: [ function(a, b) {
            function c(a, b) {
                var c = w++;
                if (b = b || {}, b.logging && (window.html2canvas.logging = !0, window.html2canvas.start = Date.now()), 
                b.async = "undefined" == typeof b.async ? !0 : b.async, b.allowTaint = "undefined" == typeof b.allowTaint ? !1 : b.allowTaint, 
                ...
                b.imageTimeout = "undefined" == typeof b.imageTimeout ? 1e4 : b.imageTimeout, b.renderer = "function" == typeof b.renderer ? b.renderer : m, 
                b.strict = !!b.strict, "string" == typeof a) {
                    if ("string" != typeof b.proxy) return k.reject("Proxy must be used when rendering url");
                    var f = null != b.width ? b.width : window.innerWidth, g = null != b.height ? b.height : window.innerHeight;
                    return t(j(a), b.proxy, document, f, g, b).then(function(a) {
                        return e(a.contentWindow.document.documentElement, a, b, f, g);
                    });
                }
                var h = (void 0 === a ? [ document.documentElement ] : a.length ? a : [ a ])[0];
                return h.setAttribute(v + c, c), d(h.ownerDocument, b, h.ownerDocument.defaultView.innerWidth, h.ownerDocument.defaultView.innerHeight, c).then(function(a) {
                    return "function" == typeof b.onrendered && (q("options.onrendered is deprecated, html2canvas returns a Promise containing the canvas"), 
                    b.onrendered(a)), a;
                });
            }
            function d(a, b, c, d, f) {
                return s(a, a, c, d, b, a.defaultView.pageXOffset, a.defaultView.pageYOffset).then(function(g) {
                    q("Document cloned");
                    var h = v + f, i = "[" + h + "='" + f + "']";
                    a.querySelector(i).removeAttribute(h);
                    var j = g.contentWindow, l = j.document.querySelector(i), m = k.resolve("function" == typeof b.onclone ? b.onclone(j.document) : !0);
            ...
            function e(a, b, c, d, e) {
                var j = b.contentWindow, k = new l(j.document), m = new n(c, k), p = u(a), r = "view" === c.type ? d : h(j.document), s = "view" === c.type ? e : i(j.document), t = new c.renderer(r, s, m, c, document), v = new o(a, t, k, m, c);
                return v.ready.then(function() {
                    q("Finished rendering");
                    var d;
                    return d = "view" === c.type ? g(t.canvas, {
                        ...
                        x: 0,
                        y: 0
                    }) : a === j.document.body || a === j.document.documentElement || null != c.canvas ? t.canvas : g(t.canvas, {
                        width: null != c.width ? c.width : p.width,
                        height: null != c.height ? c.height : p.height,
                        top: p.top,
                        left: p.left,
                        x: j.pageXOffset,
                        y: j.pageYOffset
            ...
            function f(a, b) {
                b.removeContainer && (a.parentNode.removeChild(a), q("Cleaned up container"));
            }
            function g(a, b) {
                var c = document.createElement("canvas"), d = Math.min(a.width - 1, Math.max(0, b.left)), e = Math.min(a.width, Math.max(1, b.left + b.width)), f = Math.min(a.height - 1, Math.max(0, b.top)), g = Math.min(a.height, Math.max(1, b.top + b.height));
                return c.width = b.width, c.height = b.height, q("Cropping canvas at:", "left:", b.left, "top:", b.top, "width:", e - d, "height:", g - f), 
                q("Resulting crop with width", b.width, "and height", b.height, " with x", d, "and y", f), 
                c.getContext("2d").drawImage(a, d, f, e - d, g - f, b.x, b.y, e - d, g - f), c;
            }
            function h(a) {
            ...
            var k = a("./promise"), l = a("./support"), m = a("./renderers/canvas"), n = a("./imageloader"), o = a("./nodeparser"), p = a("./nodecontainer"), q = a("./log"), r = a("./utils"), s = a("./clone"), t = a("./proxy").loadUrlDocument, u = r.getBounds, v = "data-html2canvas-node", w = 0;
            c.Promise = k, c.CanvasRenderer = m, c.NodeContainer = p, c.log = q, c.utils = r, 
            b.exports = "undefined" == typeof document || "function" != typeof Object.create || "function" != typeof document.createElement("canvas").getContext ? function() {
                return k.reject("No canvas support");
            } : c;
        }, {
            "./clone": 4,
            "./imageloader": 13,
        ...
        7: [ function(a, b) {
            function c(a) {
                if (this.src = a, e("DummyImageContainer for", a), !this.promise || !this.image) {
                    e("Initiating DummyImageContainer"), c.prototype.image = new Image();
                    var b = this.image;
                    c.prototype.promise = new d(function(a, c) {
                        b.onload = a, b.onerror = c, b.src = f(), b.complete === !0 && a(b);
                    });
                }
            }
            var d = a("./promise"), e = a("./log"), f = a("./utils").smallImage;
            b.exports = c;
        }, {
            "./log": 15,
            "./promise": 18,
        ...
        8: [ function(a, b) {
            function c(a, b) {
                var c, e, f = document.createElement("div"), g = document.createElement("img"), h = document.createElement("span"), i = "Hidden Text";
                f.style.visibility = "hidden", f.style.fontFamily = a, f.style.fontSize = b, f.style.margin = 0, 
                f.style.padding = 0, document.body.appendChild(f), g.src = d(), g.width = 1, g.height = 1, 
                g.style.margin = 0, g.style.padding = 0, g.style.verticalAlign = "baseline", h.style.fontFamily = a, 
                h.style.fontSize = b, h.style.margin = 0, h.style.padding = 0, h.appendChild(document.createTextNode(i)), 
                f.appendChild(h), f.appendChild(g), c = g.offsetTop - h.offsetTop + 1, f.removeChild(h), 
                f.appendChild(document.createTextNode(i)), f.style.lineHeight = "normal", g.style.verticalAlign = "super", 
                e = g.offsetTop - f.offsetTop + 1, document.body.removeChild(f), this.baseline = c, 
                this.lineWidth = 1, this.middle = e;
            }
        ...
        9: [ function(a, b) {
            ...
            c.prototype.getMetrics = function(a, b) {
                return void 0 === this.data[a + "-" + b] && (this.data[a + "-" + b] = new d(a, b)), 
                this.data[a + "-" + b];
            }, b.exports = c;
        }, {
            "./font": 8
        ...
        10: [ function(a, b) {
            function c(b, c, d) {
                ...
                var g = this, h = f(b);
                this.promise = (c ? new e(function(a) {
                ...
                }) : this.proxyLoad(d.proxy, h, d)).then(function(b) {
                    var c = a("./core");
            ...
            var d = a("./utils"), e = a("./promise"), f = d.getBounds, g = a("./proxy").loadUrlDocument;
            c.prototype.proxyLoad = function(a, b, c) {
                var d = this.src;
        ...
        11: [ function(a, b) {
            function c(a) {
                this.src = a.value, this.colorStops = [], this.type = null, this.x0 = .5, this.y0 = .5, 
                this.x1 = .5, this.y1 = .5, this.promise = d.resolve(!0);
            }
            var d = a("./promise");
            c.prototype.TYPES = {
                LINEAR: 1,
        ...
        12: [ function(a, b) {
            function c(a, b) {
                ...
                var c = this;
                this.tainted = null, this.promise = new d(function(d, e) {
                    c.image.onload = d, c.image.onerror = e, b && (c.image.crossOrigin = "anonymous"), 
                    c.image.src = a, c.image.complete === !0 && d(c.image);
                });
            }
            var d = a("./promise");
            b.exports = c;
        ...
        13: [ function(a, b) {
            ...
            var d = a("./promise"), e = a("./log"), f = a("./imagecontainer"), g = a("./dummyimagecontainer"), h = a("./proxyimagecontainer"), i = a("./framecontainer"), j = a("./svgcontainer"), k = a("./svgnodecontainer"), l = a("./lineargradientcontainer"), m = a("./webkitgradientcontainer"), n = a("./utils").bind;
            c.prototype.findImages = function(a) {
                ...
                return b.parseBackgroundImages().filter(this.hasImageBackground).forEach(this.addImage(a, this.loadImage), this), 
                a;
                ...
                return this.images = a.reduce(n(this.findBackgroundImage, this), this.findImages(a)), 
                ...
                }), this.ready = d.all(this.images.map(this.getPromise, this)), e("Finished searching images"), 
                this;
            }, c.prototype.timeout = function(a, b) {
                var c, f = d.race([ a.promise, new d(function(d, f) {
        ...
        14: [ function(a, b) {
            function c(a) {
                d.apply(this, arguments), this.type = this.TYPES.LINEAR;
                ...
                }, this), null === this.colorStops[0].stop && (this.colorStops[0].stop = 0), null === this.colorStops[this.colorStops.length - 1].stop && (this.colorStops[this.colorStops.length - 1].stop = 1), 
            ...
            var d = a("./gradientcontainer"), e = a("./color");
            c.prototype = Object.create(d.prototype), c.prototype.stepRegExp = /((?:rgb|rgba)\(\d{1,3},\s\d{1,3},\s\d{1,3}(?:,\s[0-9\.]+)?\))\s*(\d{1,3})?(%|px)?/, 
            b.exports = c;
        }, {
            "./color": 5,
        ...
        16: [ function(a, b) {
            function c(a, b) {
                this.node = a, this.parent = b, this.stack = null, this.bounds = null, this.borders = null, 
                this.clip = [], this.backgroundClip = [], this.offsetBounds = null, this.visible = null, 
                this.computedStyles = null, this.colors = {}, this.styles = {}, this.backgroundImages = null, 
                this.transformData = null, this.transformMatrix = null, this.isPseudoElement = !1, 
                this.opacity = null;
            }
            function d(a) {
            ...
            var i = a("./color"), j = a("./utils"), k = j.getBounds, l = j.parseBackgrounds, m = j.offsetBounds;
            c.prototype.cloneTo = function(a) {
                a.visible = this.visible, a.borders = this.borders, a.bounds = this.bounds, a.clip = this.clip, 
                a.backgroundClip = this.backgroundClip, a.computedStyles = this.computedStyles, 
                a.styles = this.styles, a.backgroundImages = this.backgroundImages, a.opacity = this.opacity;
            }, c.prototype.getOpacity = function() {
                return null === this.opacity ? this.opacity = this.cssFloat("opacity") : this.opacity;
            }, c.prototype.assignStack = function(a) {
            ...
            }, c.prototype.prefixedCss = function(a) {
            ...
            }, c.prototype.computedStyle = function(a) {
                return this.node.ownerDocument.defaultView.getComputedStyle(this.node, a);
            }, c.prototype.cssInt = function(a) {
                var b = parseInt(this.css(a), 10);
                return isNaN(b) ? 0 : b;
            }, c.prototype.color = function(a) {
                return this.colors[a] || (this.colors[a] = new i(this.css(a)));
            }, c.prototype.cssFloat = function(a) {
            ...
            }, c.prototype.cssList = function(a, b) {
                var c = (this.css(a) || "").split(",");
                return c = c[b || 0] || c[0] || "auto", c = c.trim().split(" "), 1 === c.length && (c = [ c[0], f(c[0]) ? "auto" : c[0] ]), 
                c;
            }, c.prototype.parseBackgroundSize = function(a, b, c) {
                var d, e, g = this.cssList("backgroundSize", c);
                if (f(g[0])) d = a.width * parseFloat(g[0]) / 100; else {
                    if (/contain|cover/.test(g[0])) {
                        var h = a.width / a.height, i = b.width / b.height;
                        return i > h ^ "contain" === g[0] ? {
                            width: a.height * i,
                            height: a.height
                        } : {
                            width: a.width,
                ...
                return e = "auto" === g[0] && "auto" === g[1] ? b.height : "auto" === g[1] ? d / b.width * b.height : f(g[1]) ? a.height * parseFloat(g[1]) / 100 : parseInt(g[1], 10), 
                "auto" === g[0] && (d = e / b.height * b.width), {
                    width: d,
                    height: e
                };
            }, c.prototype.parseBackgroundPosition = function(a, b, c, d) {
                var e, g, h = this.cssList("backgroundPosition", c);
                return e = f(h[0]) ? (a.width - (d || b).width) * (parseFloat(h[0]) / 100) : parseInt(h[0], 10), 
                g = "auto" === h[1] ? e / b.width * b.height : f(h[1]) ? (a.height - (d || b).height) * parseFloat(h[1]) / 100 : parseInt(h[1], 10), 
                "auto" === h[0] && (e = g / b.height * b.width), {
                    left: e,
                    top: g
                };
            }, c.prototype.parseBackgroundRepeat = function(a) {
                ...
                if (!this.transformData) if (this.hasTransform()) {
                    var a = this.parseBounds(), b = this.prefixedCss("transformOrigin").split(" ").map(g).map(h);
                ...
                if (!this.transformMatrix) {
                    var a = this.prefixedCss("transform"), b = a ? e(a.match(this.MATRIX_PROPERTY)) : null;
                    this.transformMatrix = b ? b : [ 1, 0, 0, 1, 0, 0 ];
                }
                return this.transformMatrix;
            }, c.prototype.parseBounds = function() {
                return this.bounds || (this.bounds = this.hasTransform() ? m(this.node) : k(this.node));
                ...
                return "SELECT" === this.node.tagName ? a = d(this.node) : "password" === this.node.type && (a = Array(a.length + 1).join("•")), 
                0 === a.length ? this.node.placeholder || "" : a;
            }, c.prototype.MATRIX_PROPERTY = /(matrix)\((.+)\)/, c.prototype.TEXT_SHADOW_PROPERTY = /((rgba|rgb)\([^\)]+\)(\s-?\d+px){0,})/g, 
            c.prototype.TEXT_SHADOW_VALUES = /(-?\d+px)|(#.+)|(rgb\(.+\))|(rgba\(.+\))/g, c.prototype.CLIP = /^rect\((\d+)px,? (\d+)px,? (\d+)px,? (\d+)px\)$/, 
            b.exports = c;
        }, {
            "./color": 5,
            "./utils": 29
        ...
        17: [ function(a, b) {
            function c(a, b, c, d, e) {
                N("Starting NodeParser"), this.renderer = b, this.options = e, this.range = null, 
                this.support = c, this.renderQueue = [], this.stack = new V(!0, 1, a.ownerDocument, null);
                var f = new P(a, null);
                if (e.background && b.rectangle(0, 0, b.width, b.height, new T(e.background)), a === a.ownerDocument.documentElement) {
                    var g = new P(f.color("backgroundColor").isTransparent() ? a.ownerDocument.body : a.ownerDocument.documentElement, null);
                    b.rectangle(0, 0, b.width, b.height, g.color("backgroundColor"));
                }
                f.visibile = f.isElementVisible(), this.createPseudoHideStyles(a.ownerDocument), 
                this.disableAnimations(a.ownerDocument), this.nodes = I([ f ].concat(this.getChildren(f)).filter(function(a) {
                ...
                N("Calculate overflow clips"), this.calculateOverflowClips(), N("Start fetching images"), 
                this.images = d.fetch(this.nodes.filter(A)), this.ready = this.images.ready.then(X(function() {
                    return N("Images loaded, starting parsing"), N("Creating stacking contexts"), this.createStackingContexts(), 
                    N("Sorting stacking contexts"), this.sortStackingContexts(this.stack), this.parse(this.stack), 
                    N("Render queue created with " + this.renderQueue.length + " items"), new U(X(function(a) {
                ...
                return a.map(function(e, f) {
                    if (e.width > 0) {
                        ...
                        switch (f) {
                          ...
                          case 1:
                            g = b.left + b.width - a[1].width, i = a[1].width, e.args = k({
                                c1: [ g + i, h ],
                          ...
                          case 2:
                            h = h + b.height - a[2].width, j = a[2].width, e.args = k({
                                c1: [ g + i, h + j ],
                                c2: [ g, h + j ],
                                c3: [ g + a[3].width, h ],
                                c4: [ g + i - a[3].width, h ]
            ...
            function i(a, b, c) {
                var d = a.left, e = a.top, f = a.width, g = a.height, i = b[0][0], j = b[0][1], k = b[1][0], l = b[1][1], m = b[2][0], n = b[2][1], o = b[3][0], p = b[3][1], q = f - k, r = g - n, s = f - m, t = g - p;
                return {
                    topLeftOuter: h(d, e, i, j).topLeft.subdivide(.5),
                    topLeftInner: h(d + c[3].width, e + c[0].width, Math.max(0, i - c[3].width), Math.max(0, j - c[0].width)).topLeft.subdivide(.5),
                    topRightOuter: h(d + q, e, k, l).topRight.subdivide(.5),
                    topRightInner: h(d + Math.min(q, f + c[3].width), e + c[0].width, q > f + c[3].width ? 0 : k - c[3].width, l - c[0].width).topRight.subdivide(.5),
                    bottomRightOuter: h(d + s, e + r, m, n).bottomRight.subdivide(.5),
                    bottomRightInner: h(d + Math.min(s, f - c[3].width), e + Math.min(r, g + c[0].width), Math.max(0, m - c[1].width), n - c[2].width).bottomRight.subdivide(.5),
                    bottomLeftOuter: h(d, e + t, o, p).bottomLeft.subdivide(.5),
                    bottomLeftInner: h(d + c[3].width, e + t, Math.max(0, o - c[3].width), p - c[2].width).bottomLeft.subdivide(.5)
                };
            }
            function j(a, b, c, d) {
                ...
                return {
                    ...
                    subdivide: function(f) {
                        var g = e(a, b, f), h = e(b, c, f), i = e(c, d, f), k = e(g, h, f), l = e(h, i, f), m = e(k, l, f);
                        return [ j(a, g, k, m), j(m, l, i, d) ];
                    },
                    curveTo: function(a) {
            ...
            function k(a, b, c, d, e, f, g) {
                ...
                c[0] > 0 || c[1] > 0 ? (h.push([ "line", f[0].start.x, f[0].start.y ]), f[0].curveTo(h), 
                h.push([ "line", g[0].end.x, g[0].end.y ]), g[0].curveToReversed(h)) : (h.push([ "line", a.c2[0], a.c2[1] ]), 
                h.push([ "line", a.c3[0], a.c3[1] ])), b[0] > 0 || b[1] > 0 ? (h.push([ "line", e[1].end.x, e[1].end.y ]), 
                e[1].curveToReversed(h)) : h.push([ "line", a.c4[0], a.c4[1] ]), h;
            }
            function l(a, b, c, d, e, f, g) {
                b[0] > 0 || b[1] > 0 ? (a.push([ "line", d[0].start.x, d[0].start.y ]), d[0].curveTo(a), 
                d[1].curveTo(a)) : a.push([ "line", f, g ]), (c[0] > 0 || c[1] > 0) && a.push([ "line", e[0].start.x, e[0].start.y ]);
            }
            function m(a) {
            ...
            function t(a) {
                return [ "TopLeft", "TopRight", "BottomRight", "BottomLeft" ].map(function(b) {
                    ...
                    return d.length <= 1 && (d[1] = d[0]), d.map(F);
                });
            }
            function u(a) {
            ...
            function v(a) {
                var b = a.css("position"), c = -1 !== [ "absolute", "relative", "fixed" ].indexOf(b) ? a.css("zIndex") : "auto";
                return "auto" !== c;
            }
            function w(a) {
            ...
            function K(a) {
                for (var b, c = [], d = 0, e = !1; a.length; ) L(a[d]) === e ? (b = a.splice(0, d), 
                b.length && c.push(O.ucs2.encode(b)), e = !e, d = 0) : d++, d >= a.length && (b = a.splice(0, d), 
                b.length && c.push(O.ucs2.encode(b)));
                return c;
            }
            function L(a) {
            ...
            var N = a("./log"), O = a("punycode"), P = a("./nodecontainer"), Q = a("./textcontainer"), R = a("./pseudoelementcontainer"), S = a("./fontmetrics"), T = a("./color"), U = a("./promise"), V = a("./stackingcontext"), W = a("./utils"), X = W.bind, Y = W.getBounds, Z = W.parseBackgrounds, $ = W.offsetBounds;
            c.prototype.calculateOverflowClips = function() {
                this.nodes.forEach(function(a) {
                    if (A(a)) {
                        B(a) && a.appendToDOM(), a.borders = this.parseBorders(a);
                        ...
                        a.clip = d(a) ? a.parent.clip.concat(b) : b, a.backgroundClip = "hidden" !== a.css("overflow") ? a.clip.concat([ a.borders.clip ]) : a.clip, 
                        B(a) && a.cleanDOM();
                    } else C(a) && (a.clip = d(a) ? a.parent.clip : []);
                    B(a) || (a.bounds = null);
                }, this);
            }, c.prototype.asyncRenderer = function(a, b, c) {
            ...
            }, c.prototype.createPseudoHideStyles = function(a) {
                this.createStyles(a, "." + R.prototype.PSEUDO_HIDE_ELEMENT_CLASS_BEFORE + ':before { content: "" !important; display: none !important; }.' + R.prototype.PSEUDO_HIDE_ELEMENT_CLASS_AFTER + ':after { content: "" !important; display: none !important; }');
            }, c.prototype.disableAnimations = function(a) {
            ...
            }, c.prototype.createStyles = function(a, b) {
                var c = a.createElement("style");
                c.innerHTML = b, a.body.appendChild(c);
            }, c.prototype.getPseudoElements = function(a) {
                var b = [ [ a ] ];
                ...
                return I(b);
            }, c.prototype.getPseudoElement = function(a, b) {
                var c = a.computedStyle(b);
                if (!c || !c.content || "none" === c.content || "-moz-alt-content" === c.content || "none" === c.display) return null;
                for (var d = J(c.content), f = "url" === d.substr(0, 3), g = document.createElement(f ? "img" : "html2canvaspseudoelement"), h = new R(g, a, b), i = c.length - 1; i >= 0; i--) {
                    var j = e(c.item(i));
                    g.style[j] = c[j];
                }
                if (g.className = R.prototype.PSEUDO_HIDE_ELEMENT_CLASS_BEFORE + " " + R.prototype.PSEUDO_HIDE_ELEMENT_CLASS_AFTER, 
                f) return g.src = Z(d)[0].args[0], [ h ];
                var k = document.createTextNode(d);
                return g.appendChild(k), [ h, new Q(k, h) ];
            }, c.prototype.getChildren = function(a) {
                return I([].filter.call(a.node.childNodes, u).map(function(b) {
                    var c = [ b.nodeType === Node.TEXT_NODE ? new Q(b, a) : new P(b, a) ].filter(H);
                    return b.nodeType === Node.ELEMENT_NODE && c.length && "TEXTAREA" !== b.tagName ? c[0].isElementVisible() ? c.concat(this.getChildren(c[0])) : [] : c;
                }, this));
            }, c.prototype.newStackingContext = function(a, b) {
                var c = new V(b, a.getOpacity(), a.node, a.parent);
                a.cloneTo(c);
                var d = b ? c.getParentStack(this) : c.parent.stack;
                d.contexts.push(c), a.stack = c;
            }, c.prototype.createStackingContexts = function() {
                this.nodes.forEach(function(a) {
                    A(a) && (this.isRootElement(a) || E(a) || v(a) || this.isBodyWithTransparentRoot(a) || a.hasTransform()) ? this.newStackingContext(a, !0) : A(a) && (w(a) && o(a) || y(a) || x(a)) ? this.newStackingContext(a, !1) : a.assignStack(a.parent.stack);
                }, this);
            }, c.prototype.isBodyWithTransparentRoot = function(a) {
                return "BODY" === a.node.nodeName && a.parent.color("backgroundColor").isTransparent();
            }, c.prototype.isRootElement = function(a) {
                return null === a.parent;
            }, c.prototype.sortStackingContexts = function(a) {
                a.contexts.sort(D(a.contexts.slice(0))), a.contexts.forEach(this.sortStackingContexts, this);
            }, c.prototype.parseTextBounds = function(a) {
            ...
            }, c.prototype.getWrapperBounds = function(a, b) {
            ...
            }, c.prototype.getRangeBounds = function(a, b, c) {
                ...
                var b = a.contexts.filter(m), c = a.children.filter(A), d = c.filter(z(x)), e = d.filter(z(w)).filter(z(p)), g = c.filter(z(w)).filter(x), h = d.filter(z(w)).filter(p), i = a.contexts.concat(d.filter(w)).filter(o), j = a.children.filter(C).filter(r), k = a.contexts.filter(n);
                b.concat(e).concat(g).concat(h).concat(i).concat(j).concat(k).forEach(function(a) {
                    this.renderQueue.push(a), q(a) && (this.parse(a), this.renderQueue.push(new f()));
                }, this);
            }, c.prototype.paint = function(a) {
                try {
                    a instanceof f ? this.renderer.ctx.restore() : C(a) ? (B(a.parent) && a.parent.appendToDOM(), 
                    this.paintText(a), B(a.parent) && a.parent.cleanDOM()) : this.paintNode(a);
                } catch (b) {
                    if (N(b), this.options.strict) throw b;
                }
            }, c.prototype.paintNode = function(a) {
                q(a) && (this.renderer.setOpacity(a.opacity), this.renderer.ctx.save(), a.hasTransform() && this.renderer.setTransform(a.parseTransform())), 
            ...
            }, c.prototype.paintElement = function(a) {
                var b = a.parseBounds();
                this.renderer.clip(a.backgroundClip, function() {
                    this.renderer.renderBackground(a, b, a.borders.borders.map(G));
                    ...
                    switch (a.node.nodeName) {
                      ...
                      case "IFRAME":
                        ...
                        c ? this.renderer.renderImage(a, b, a.borders, c) : N("Error loading <" + a.node.nodeName + ">", a.node);
                        break;

                      case "IMG":
                        var d = this.images.get(a.node.src);
                        d ? this.renderer.renderImage(a, b, a.borders, d) : N("Error loading <img>", a.node.src);
                        break;
            ...
            }, c.prototype.paintCheckbox = function(a) {
                var b = a.parseBounds(), c = Math.min(b.width, b.height), d = {
                    width: c - 1,
                    height: c - 1,
                    top: b.top,
                    left: b.left
                }, e = [ 3, 3 ], f = [ e, e, e, e ], h = [ 1, 1, 1, 1 ].map(function(a) {
                    return {
                        color: new T("#A5A5A5"),
                        width: a
                    };
                ...
                this.renderer.clip(a.backgroundClip, function() {
                    ...
                    this.renderer.renderBorders(g(h, d, j, f)), a.node.checked && (this.renderer.font(new T("#424242"), "normal", "normal", "bold", c - 3 + "px", "arial"), 
                    this.renderer.text("✔", d.left + c / 6, d.top + c - 1));
                }, this);
            }, c.prototype.paintRadio = function(a) {
            ...
            }, c.prototype.paintFormValue = function(a) {
                var b = a.getValue();
                if (b.length > 0) {
                    var c = a.node.ownerDocument, d = c.createElement("html2canvaswrapper"), e = [ "lineHeight", "textAlign", "fontFamily", "fontWeight", "fontSize", "color", "paddingLeft", "paddingTop", "paddingRight", "paddingBottom", "width", "height", "borderLeftStyle", "borderTopStyle", "borderLeftWidth", "borderTopWidth", "boxSizing", "whiteSpace", "wordWrap" ];
                    e.forEach(function(b) {
                        try {
                            d.style[b] = a.css(b);
                        } catch (c) {
                            N("html2canvas: Parse: Exception caught in renderFormValue: " + c.message);
                        }
                    });
                    var f = a.parseBounds();
                    d.style.position = "fixed", d.style.left = f.left + "px", d.style.top = f.top + "px", 
                    d.textContent = b, c.body.appendChild(d), this.paintText(new Q(d.firstChild, a)), 
                    c.body.removeChild(d);
                }
            }, c.prototype.paintText = function(a) {
                a.applyTextTransform();
                var b = O.ucs2.decode(a.node.data), c = this.options.letterRendering && !s(a) || M(a.node.data) ? b.map(function(a) {
                    return O.ucs2.encode([ a ]);
                }) : K(b), d = a.parent.fontWeight(), e = a.parent.css("fontSize"), f = a.parent.css("fontFamily"), g = a.parent.parseTextShadows();
                this.renderer.font(a.parent.color("color"), a.parent.css("fontStyle"), a.parent.css("fontVariant"), d, e, f), 
                g.length ? this.renderer.fontShadow(g[0].color, g[0].offsetX, g[0].offsetY, g[0].blur) : this.renderer.clearShadow(), 
            ...
            }, c.prototype.renderTextDecoration = function(a, b, c) {
            ...
            c.prototype.parseBorders = function(a) {
                var b = a.parseBounds(), c = t(a), d = [ "Top", "Right", "Bottom", "Left" ].map(function(b, c) {
            ...
            }, c.prototype.parseBackgroundClip = function(a, b, c, d, e) {
                var f = a.css("backgroundClip"), g = [];
                switch (f) {
                  case "content-box":
                  case "padding-box":
                    l(g, d[0], d[1], b.topLeftInner, b.topRightInner, e.left + c[3].width, e.top + c[0].width), 
                    l(g, d[1], d[2], b.topRightInner, b.bottomRightInner, e.left + e.width - c[1].width, e.top + c[0].width), 
                    l(g, d[2], d[3], b.bottomRightInner, b.bottomLeftInner, e.left + e.width - c[1].width, e.top + e.height - c[2].width), 
                    l(g, d[3], d[0], b.bottomLeftInner, b.topLeftInner, e.left + c[3].width, e.top + e.height - c[2].width);
                    break;

                  default:
                    l(g, d[0], d[1], b.topLeftOuter, b.topRightOuter, e.left, e.top), l(g, d[1], d[2], b.topRightOuter, b.bottomRightOuter, e.left + e.width, e.top), 
                    l(g, d[2], d[3], b.bottomRightOuter, b.bottomLeftOuter, e.left + e.width, e.top + e.height), 
                    l(g, d[3], d[0], b.bottomLeftOuter, b.topLeftOuter, e.left, e.top + e.height);
                }
                return g;
            }, b.exports = c;
        }, {
        ...
        18: [ function(a, b) {
            b.exports = a("es6-promise").Promise;
        }, {
            "es6-promise": 1
        } ],
        19: [ function(a, b, c) {
            function d(a, b, c) {
                ...
                if (!b) return k.reject("No proxy configured");
                var e = g(d), i = h(b, a, e);
                return d ? l(i) : f(c, i, e).then(function(a) {
                    return p(a.content);
                });
            }
            function e(a, b, c) {
                var d = "crossOrigin" in new Image(), e = g(d), i = h(b, a, e);
                return d ? k.resolve(i) : f(c, i, e).then(function(a) {
            ...
            function g(a) {
                return a ? "" : "html2canvas_" + Date.now() + "_" + ++q + "_" + Math.round(1e5 * Math.random());
            }
            function h(a, b, c) {
            ...
            function i(a) {
                return function(b) {
                    ...
                    try {
                        ...
                        n("DOMParser not supported, falling back to createHTMLDocument"), c = document.implementation.createHTMLDocument("");
                        try {
                            c.open(), c.write(b), c.close();
                        } catch (f) {
                            n("createHTMLDocument write not supported, falling back to document.body.innerHTML"), 
                            c.body.innerHTML = b;
                        }
                    }
            ...
            function j(a, b, c, e, f, g) {
                return new d(a, b, window.document).then(i(a)).then(function(a) {
                    return o(a, c, e, f, g, 0, 0);
                });
            }
            var k = a("./promise"), l = a("./xhr"), m = a("./utils"), n = a("./log"), o = a("./clone"), p = m.decode64, q = 0;
        ...
        20: [ function(a, b) {
            function c(a, b) {
                ...
                var f = this;
                this.promise = new e(function(c, e) {
                    f.image.crossOrigin = "Anonymous", f.image.onload = c, f.image.onerror = e, new d(a, b, document).then(function(a) {
                        f.image.src = a;
                    })["catch"](e);
                });
            }
            var d = a("./proxy").ProxyURL, e = a("./promise");
            b.exports = c;
        }, {
            "./promise": 18,
            "./proxy": 19
        ...
        21: [ function(a, b) {
            ...
            c.prototype.cloneTo = function(a) {
                c.prototype.cloneTo.call(this, a), a.isPseudoElement = !0, a.before = this.before;
            }, c.prototype = Object.create(d.prototype), c.prototype.appendToDOM = function() {
            ...
            }, c.prototype.getHideClass = function() {
                return this["PSEUDO_HIDE_ELEMENT_CLASS_" + (this.before ? "BEFORE" : "AFTER")];
            }, c.prototype.PSEUDO_HIDE_ELEMENT_CLASS_BEFORE = "___html2canvas___pseudoelement_before", 
            c.prototype.PSEUDO_HIDE_ELEMENT_CLASS_AFTER = "___html2canvas___pseudoelement_after", 
            b.exports = c;
        }, {
            "./nodecontainer": 16
        } ],
        22: [ function(a, b) {
            ...
            var d = a("./log");
            c.prototype.renderImage = function(a, b, c, d) {
                var e = a.cssInt("paddingLeft"), f = a.cssInt("paddingTop"), g = a.cssInt("paddingRight"), h = a.cssInt("paddingBottom"), i = c.borders, j = b.width - (i[1].width + i[3].width + e + g), k = b.height - (i[0].width + i[2].width + f + h);
                this.drawImage(d, 0, 0, d.image.width || j, d.image.height || k, b.left + e + i[3].width, b.top + f + i[0].width, j, k);
            }, c.prototype.renderBackground = function(a, b, c) {
                b.height > 0 && b.width > 0 && (this.renderBackgroundColor(a, b), this.renderBackgroundImage(a, b, c));
            }, c.prototype.renderBackgroundColor = function(a, b) {
                var c = a.color("backgroundColor");
                c.isTransparent() || this.rectangle(b.left, b.top, b.width, b.height, c);
            }, c.prototype.renderBorders = function(a) {
                a.forEach(this.renderBorder, this);
            }, c.prototype.renderBorder = function(a) {
                a.color.isTransparent() || null === a.args || this.drawShape(a.args, a.color);
            }, c.prototype.renderBackgroundImage = function(a, b, c) {
                var e = a.parseBackgroundImages();
                e.reverse().forEach(function(e, f, g) {
                    switch (e.method) {
                      case "url":
                        var h = this.images.get(e.args[0]);
                        h ? this.renderBackgroundRepeating(a, b, h, g.length - (f + 1), c) : d("Error loading background-image", e.args[0]);
                        break;

                      case "linear-gradient":
                      case "gradient":
                        var i = this.images.get(e.value);
                        i ? this.renderBackgroundGradient(i, b, c) : d("Error loading background-image", e.args[0]);
                        break;
            ...
            }, c.prototype.renderBackgroundRepeating = function(a, b, c, d, e) {
                var f = a.parseBackgroundSize(b, c.image, d), g = a.parseBackgroundPosition(b, c.image, d, f), h = a.parseBackgroundRepeat(d);
                switch (h) {
                  case "repeat-x":
        ...
        23: [ function(a, b) {
            function c(a, b) {
                e.apply(this, arguments), this.canvas = this.options.canvas || this.document.createElement("canvas"), 
                this.options.canvas || (this.canvas.width = a, this.canvas.height = b), this.ctx = this.canvas.getContext("2d"), 
                this.taintCtx = this.document.createElement("canvas").getContext("2d"), this.ctx.textBaseline = "bottom", 
                this.variables = {}, g("Initialized CanvasRenderer with size", a, "x", b);
            }
            function d(a) {
                return a.length > 0;
            }
            var e = a("../renderer"), f = a("../lineargradientcontainer"), g = a("../log");
            c.prototype = Object.create(e.prototype), c.prototype.setFillStyle = function(a) {
                return this.ctx.fillStyle = "object" == typeof a && a.isColor ? a.toString() : a, 
                this.ctx;
            }, c.prototype.rectangle = function(a, b, c, d, e) {
                this.setFillStyle(e).fillRect(a, b, c, d);
            }, c.prototype.circle = function(a, b, c, d) {
                this.setFillStyle(d), this.ctx.beginPath(), this.ctx.arc(a + c / 2, b + c / 2, c / 2, 0, 2 * Math.PI, !0), 
                this.ctx.closePath(), this.ctx.fill();
            }, c.prototype.circleStroke = function(a, b, c, d, e, f) {
                this.circle(a, b, c, d), this.ctx.strokeStyle = f.toString(), this.ctx.stroke();
            }, c.prototype.drawShape = function(a, b) {
                this.shape(a), this.setFillStyle(b).fill();
            }, c.prototype.taints = function(a) {
                if (null === a.tainted) {
                ...
                return a.tainted;
            }, c.prototype.drawImage = function(a, b, c, d, e, f, g, h, i) {
                (!this.taints(a) || this.options.allowTaint) && this.ctx.drawImage(a.image, b, c, d, e, f, g, h, i);
            }, c.prototype.clip = function(a, b, c) {
                this.ctx.save(), a.filter(d).forEach(function(a) {
                    this.shape(a).clip();
                }, this), b.call(c), this.ctx.restore();
            }, c.prototype.shape = function(a) {
            ...
            }, c.prototype.font = function(a, b, c, d, e, f) {
                this.setFillStyle(a).font = [ b, c, d, e, f ].join(" ").split(",")[0];
            }, c.prototype.fontShadow = function(a, b, c, d) {
                ...
                this.ctx.translate(a.origin[0], a.origin[1]), this.ctx.transform.apply(this.ctx, a.matrix), 
                this.ctx.translate(-a.origin[0], -a.origin[1]);
            }, c.prototype.setVariable = function(a, b) {
                return this.variables[a] !== b && (this.variables[a] = this.ctx[a] = b), this;
            }, c.prototype.text = function(a, b, c) {
                this.ctx.fillText(a, b, c);
            }, c.prototype.backgroundRepeatShape = function(a, b, c, d, e, f, g, h, i) {
            ...
            }, c.prototype.renderBackgroundRepeat = function(a, b, c, d, e, f) {
                var g = Math.round(d.left + b.left + e), h = Math.round(d.top + b.top + f);
                this.setFillStyle(this.ctx.createPattern(this.resizeImage(a, c), "repeat")), this.ctx.translate(g, h), 
                this.ctx.fill(), this.ctx.translate(-g, -h);
            }, c.prototype.renderBackgroundGradient = function(a, b) {
                if (a instanceof f) {
            ...
            }, c.prototype.resizeImage = function(a, b) {
                var c = a.image;
                if (c.width === b.width && c.height === b.height) return c;
                var d, e = document.createElement("canvas");
                return e.width = b.width, e.height = b.height, d = e.getContext("2d"), d.drawImage(c, 0, 0, c.width, c.height, 0, 0, b.width, b.height), 
                e;
            }, b.exports = c;
        }, {
            "../lineargradientcontainer": 14,
        ...
        24: [ function(a, b) {
            function c(a, b, c, e) {
                d.call(this, c, e), this.ownStacking = a, this.contexts = [], this.children = [], 
                this.opacity = (this.parent ? this.parent.stack.opacity : 1) * b;
            }
            var d = a("./nodecontainer");
            c.prototype = Object.create(d.prototype), c.prototype.getParentStack = function(a) {
        ...
        25: [ function(a, b) {
            ...
            c.prototype.testRangeBounds = function(a) {
                var b, c, d, e, f = !1;
                return a.createRange && (b = a.createRange(), b.getBoundingClientRect && (c = a.createElement("boundtest"), 
                c.style.height = "123px", c.style.display = "block", a.body.appendChild(c), b.selectNode(c), 
                d = b.getBoundingClientRect(), e = d.height, 123 === e && (f = !0), a.body.removeChild(c))), 
                f;
            }, c.prototype.testCORS = function() {
                return "undefined" != typeof new Image().crossOrigin;
            }, c.prototype.testSVG = function() {
        ...
        26: [ function(a, b) {
            function c(a) {
                ...
                this.promise = this.hasFabric().then(function() {
                    return b.isInline(a) ? d.resolve(b.inlineFormatting(a)) : e(a);
                }).then(function(a) {
            ...
            var d = a("./promise"), e = a("./xhr"), f = a("./utils").decode64;
            c.prototype.hasFabric = function() {
                return window.html2canvas.svg && window.html2canvas.svg.fabric ? d.resolve() : d.reject(new Error("html2canvas.svg.js is not loaded, cannot render svg"));
            }, c.prototype.inlineFormatting = function(a) {
                return /^data:image\/svg\+xml;base64,/.test(a) ? this.decode64(this.removeContentType(a)) : this.removeContentType(a);
            }, c.prototype.removeContentType = function(a) {
                return a.replace(/^data:image\/svg\+xml(;base64)?,/, "");
            }, c.prototype.isInline = function(a) {
                return /^data:image\/svg\+xml/i.test(a);
            }, c.prototype.createCanvas = function(a) {
                var b = this;
                return function(c, d) {
                    var e = new window.html2canvas.svg.fabric.StaticCanvas("c");
                    b.image = e.lowerCanvasEl, e.setWidth(d.width).setHeight(d.height).add(window.html2canvas.svg.fabric.util.groupSVGElements(c, d)).renderAll(), 
                    a(e.lowerCanvasEl);
                };
            }, c.prototype.decode64 = function(a) {
        ...
        27: [ function(a, b) {
            function c(a, b) {
                this.src = a, this.image = null;
                var c = this;
                this.promise = b ? new e(function(b, d) {
                    c.image = new Image(), c.image.onload = b, c.image.onerror = d, c.image.src = "data:image/svg+xml," + new XMLSerializer().serializeToString(a), 
            ...
            var d = a("./svgcontainer"), e = a("./promise");
            c.prototype = Object.create(d.prototype), b.exports = c;
        }, {
            "./promise": 18,
            "./svgcontainer": 26
        } ],
        28: [ function(a, b) {
            ...
            c.prototype = Object.create(e.prototype), c.prototype.applyTextTransform = function() {
        ...
        29: [ function(a, b, c) {
            c.smallImage = function() {
                ...
                for (b = 0; k > b; b += 4) c = j.indexOf(a[b]), d = j.indexOf(a[b + 1]), e = j.indexOf(a[b + 2]), 
                f = j.indexOf(a[b + 3]), g = c << 2 | d >> 4, h = (15 & d) << 4 | e >> 2, i = (3 & e) << 6 | f, 
                ...
                var b, c, d, e, f, g, h, i = " \r\n	", j = [], k = 0, l = 0, m = function() {
                    b && ('"' === c.substr(0, 1) && (c = c.substr(1, c.length - 2)), c && h.push(c), 
        ...
        30: [ function(a, b) {
            function c(a) {
                d.apply(this, arguments), this.type = "linear" === a.args[0] ? this.TYPES.LINEAR : this.TYPES.RADIAL;
            }
...
(function a(b, c, d) {
    ...
    1: [ function(a, b, c) {
        window._template = a("lodash.template");
    }, {
        "lodash.template": 8
    } ],
    2: [ function(a, b, c) {
    ...
    3: [ function(a, b, c) {
        var d = a("lodash.keysin"), e = a("lodash.rest");
        var f = 9007199254740991;
        var g = "[object Function]", h = "[object GeneratorFunction]";
        var i = /^(?:0|[1-9]\d*)$/;
        ...
        function m(a, b, c) {
            var d = a[b];
            if (!(k.call(a, b) && t(d, c)) || c === undefined && !(b in a)) {
                a[b] = c;
            }
        }
        function n(a) {
        ...
        function p(a) {
            return e(function(b, c) {
                var d = -1, e = c.length, f = e > 1 ? c[e - 1] : undefined, g = e > 2 ? c[2] : undefined;
                f = a.length > 3 && typeof f == "function" ? (e--, f) : undefined;
                if (g && s(c[0], c[1], g)) {
                    f = e < 3 ? undefined : f;
                    e = 1;
                }
        ...
        function r(a, b) {
            b = b == null ? f : b;
            return !!b && (typeof a == "number" || i.test(a)) && (a > -1 && a % 1 == 0 && a < b);
        }
        function s(a, b, c) {
            if (!x(c)) {
                return false;
            ...
            var d = typeof b;
            if (d == "number" ? u(c) && r(b, c.length) : d == "string" && b in c) {
                return t(c[b], a);
            }
            return false;
        }
    ...
    4: [ function(a, b, c) {
        var d = a("lodash.tostring");
        var e = /[&<>"'`]/g, f = RegExp(e.source);
        var g = {
            "&": "&amp;",
            "<": "&lt;",
            ">": "&gt;",
        ...
        function i(a) {
            a = d(a);
            return a && f.test(a) ? a.replace(e, h) : a;
        }
        b.exports = i;
    }, {
        "lodash.tostring": 10
    ...
    5: [ function(a, b, c) {
        ...
        var e = "[object Arguments]", f = "[object Function]", g = "[object GeneratorFunction]", h = "[object String]";
        var i = /^(?:0|[1-9]\d*)$/;
        function j(a, b) {
            var c = -1, d = Array(a);
            while (++c < a) {
        ...
        var l = k.hasOwnProperty;
        var m = k.toString;
        var n = k.propertyIsEnumerable;
        var o = Object.getPrototypeOf, p = Object.keys;
        function q(a, b) {
            return l.call(a, b) || typeof a == "object" && b in a && u(a) === null;
        }
        function r(a) {
            return p(Object(a));
        }
        ...
        function x(a) {
            var b = a && a.constructor, c = typeof b == "function" && b.prototype || k;
            return a === c;
        }
        function y(a) {
            return B(a) && l.call(a, "callee") && (!n.call(a, "callee") || m.call(a) == e);
        }
        var z = Array.isArray;
        function A(a) {
            return a != null && D(t(a)) && !C(a);
        }
        function B(a) {
            return F(a) && A(a);
        }
        ...
        function G(a) {
            return typeof a == "string" || !z(a) && F(a) && m.call(a) == h;
        }
        function H(a) {
            var b = x(a);
            if (!(b || A(a))) {
            ...
            var c = v(a), d = !!c, e = c || [], f = e.length;
            for (var g in a) {
                if (q(a, g) && !(d && (g == "length" || w(g, f))) && !(b && g == "constructor")) {
                    e.push(g);
                }
            }
            return e;
    ...
    6: [ function(a, b, c) {
        (function(a) {
            ...
            var k = j[typeof c] && c && !c.nodeType ? c : undefined;
            var l = j[typeof b] && b && !b.nodeType ? b : undefined;
            var m = s(k && l && typeof a == "object" && a);
            var n = s(j[typeof self] && self);
            var o = s(j[typeof window] && window);
            var p = s(j[typeof this] && this);
            var q = m || o !== (p && p.window) && o || n || p || Function("return this")();
            function r(a, b) {
                var c = -1, d = Array(a);
                while (++c < a) {
                    d[c] = b(c);
            ...
            var w = u.toString;
            var x = q.Reflect, y = x ? x.enumerate : undefined, z = u.propertyIsEnumerable;
            function A(a) {
                a = a == null ? a : Object(a);
                var b = [];
                for (var c in a) {
            ...
            function F(a) {
                var b = a && a.constructor, c = typeof b == "function" && b.prototype || u;
                return a === c;
            }
            function G(a) {
                return J(a) && v.call(a, "callee") && (!z.call(a, "callee") || w.call(a) == e);
            }
            var H = Array.isArray;
            function I(a) {
                return a != null && L(C(a)) && !K(a);
            }
            function J(a) {
                return N(a) && I(a);
            }
            ...
            function O(a) {
                return typeof a == "string" || !H(a) && N(a) && w.call(a) == h;
            }
            function P(a) {
                var b = -1, c = F(a), d = A(a), e = d.length, f = D(a), g = !!f, h = f || [], i = h.length;
                while (++b < e) {
                    var j = d[b];
                    if (!(g && (j == "length" || E(j, i))) && !(j == "constructor" && (c || !v.call(a, j)))) {
                        h.push(j);
                    }
                }
                return h;
    ...
    7: [ function(a, b, c) {
        ...
        var e = 1 / 0, f = 1.7976931348623157e308, g = 0 / 0;
        var h = "[object Function]", i = "[object GeneratorFunction]", j = "[object Symbol]";
        var k = /^\s+|\s+$/g;
        var l = /^[-+]0x[0-9a-f]+$/i;
        var m = /^0b[01]+$/i;
        var n = /^0o[0-7]+$/i;
        ...
        function t(a, b) {
            ...
            b = s(b === undefined ? a.length - 1 : z(b), 0);
            return function() {
                var c = arguments, d = -1, e = s(c.length - b, 0), f = Array(e);
                while (++d < e) {
                    f[d] = c[b + d];
                }
                switch (b) {
        ...
        function x(a) {
            return typeof a == "symbol" || w(a) && r.call(a) == j;
        }
        function y(a) {
            if (!a) {
                return a === 0 ? a : 0;
        ...
        function A(a) {
            ...
            a = a.replace(k, "");
            var c = m.test(a);
            return c || n.test(a) ? o(a.slice(2), c ? 2 : 8) : l.test(a) ? g : +a;
        }
        b.exports = t;
    }, {} ],
    8: [ function(a, b, c) {
        var d = a("lodash.assigninwith"), e = a("lodash.keys"), f = a("lodash._reinterpolate"), g = a("lodash.rest"), h = a("lodash.templatesettings"), i = a("lodash.tostring");
        var j = 9007199254740991;
        var k = "[object Error]", l = "[object Function]", m = "[object GeneratorFunction]";
        var n = /\b__p \+= '';/g, o = /\b(__p \+=) '' \+/g, p = /(__e\(.*?\)|\b__t\)) \+\n'';/g;
        var q = /\$\{([^\\}]*(?:\\.[^\\}]*)*)\}/g;
        var r = /^(?:0|[1-9]\d*)$/;
        var s = /($^)/;
        var t = /['\n\r\u2028\u2029\\]/g;
        ...
        var A = z.hasOwnProperty;
        var B = z.toString;
        function C(a, b, c, d) {
            if (a === undefined || H(a, z[c]) && !A.call(d, c)) {
                return b;
            }
            return a;
        }
        ...
        function F(a, b) {
            b = b == null ? j : b;
            return !!b && (typeof a == "number" || r.test(a)) && (a > -1 && a % 1 == 0 && a < b);
        }
        function G(a, b, c) {
            if (!M(c)) {
                return false;
            ...
            var d = typeof b;
            if (d == "number" ? I(c) && F(b, c.length) : d == "string" && b in c) {
                return H(c[b], a);
            }
            return false;
        }
        ...
        function I(a) {
            return a != null && L(E(a)) && !K(a);
        }
        function J(a) {
            if (!N(a)) {
                return false;
            }
            return B.call(a) == k || typeof a.message == "string" && typeof a.name == "string";
        }
        function K(a) {
            var b = M(a) ? B.call(a) : "";
            return b == l || b == m;
        ...
        function O(a, b, c) {
            var g = h.imports._.templateSettings || h;
            if (c && G(a, b, c)) {
                b = undefined;
            }
            a = i(a);
            b = d({}, b, g, C);
            var j = d({}, b.imports, g.imports, C), k = e(j), l = x(j, k);
            var m, r, u = 0, v = b.interpolate || s, w = "__p += '";
            var z = RegExp((b.escape || s).source + "|" + v.source + "|" + (v === f ? q : s).source + "|" + (b.evaluate || s).source + "|$", "g");
            var A = "sourceURL" in b ? "//# sourceURL=" + b.sourceURL + "\n" : "";
            a.replace(z, function(b, c, d, e, f, g) {
                d || (d = e);
                w += a.slice(u, g).replace(t, y);
                if (c) {
                    m = true;
                    w += "' +\n__e(" + c + ") +\n'";
                }
            ...
            w = (r ? w.replace(n, "") : w).replace(o, "$1").replace(p, "$1;");
            w = "function(" + (B || "obj") + ") {\n" + (B ? "" : "obj || (obj = {});\n") + "var __t, __p = ''" + (m ? ", __e = _.escape" : "") + (r ? ", __j = Array.prototype.join;\n" + "function print() { __p += __j.call(arguments, '') }\n" : ";\n") + w + "return __p\n}";
            var D = P(function() {
                return Function(k, A + "return " + w).apply(undefined, l);
            });
            D.source = w;
            if (J(D)) {
                throw D;
        ...
        var P = g(function(a, b) {
            try {
                return v(a, undefined, b);
            } catch (c) {
                return J(c) ? c : new Error(c);
            }
        });
        b.exports = O;
    }, {
        "lodash._reinterpolate": 2,
        "lodash.assigninwith": 3,
        "lodash.keys": 5,
        "lodash.rest": 7,
    ...
    9: [ function(a, b, c) {
        var d = a("lodash.escape"), e = a("lodash._reinterpolate");
        var f = /<%-([\s\S]+?)%>/g, g = /<%([\s\S]+?)%>/g;
        var h = {
            escape: f,
            evaluate: g,
    ...
    10: [ function(a, b, c) {
        (function(a) {
            ...
            var g = f[typeof c] && c && !c.nodeType ? c : undefined;
            var h = f[typeof b] && b && !b.nodeType ? b : undefined;
            var i = n(g && h && typeof a == "object" && a);
            var j = n(f[typeof self] && self);
            var k = n(f[typeof window] && window);
            var l = n(f[typeof this] && this);
            var m = i || k !== (l && l.window) && k || j || l || Function("return this")();
            function n(a) {
                return a && a.Object === Object ? a : null;
            }
            ...
            var p = o.toString;
            var q = m.Symbol;
            var r = q ? q.prototype : undefined, s = r ? r.toString : undefined;
            function t(a) {
                if (typeof a == "string") {
                    return a;
                }
                ...
                var b = a + "";
                return b == "0" && 1 / a == -d ? "-0" : b;
            }
            function u(a) {
                return !!a && typeof a == "object";
            }
            function v(a) {
                return typeof a == "symbol" || u(a) && p.call(a) == e;
            }
            function w(a) {
                return a == null ? "" : t(a);
            }
...
window.pluginTool = function(a, b) {
    var c = chrome.storage.local;
    function d(a, b) {
        c.get(a, b);
    }
    function e(b, c, e) {
...
$(function() {
    ...
    var a = function() {
        var a = $(".main-wrap"), b = {};
        b.title = a.find(".topic-title").text();
        b.author = a.find(".author span").text();
        b.date = a.find(".release-date").text();
        b.content = a.find("#article-body").html();
        $("body").append('<div id="pluginDOM"><div id="plugin-content"></div></div>');
        var c = $("#pluginDOM"), d = c.find("#plugin-content");
        ...
        e("article-title", b.title);
        e("article-date", b.date);
        e("article-author", b.author);
        e("article-content", b.content, "dom");
        d.find("img").each(function() {
            $(this).removeClass("js-lazy blur loaded").attr("src", $(this).data("src") + "?imageView2/2/w/750").removeData("action src original vw");
        });
        d.append('<img id="article-footerimg" class="hide"></div>');
        function e(a, b, c) {
            c = c || "text";
            d.append('<div class="' + a + '"></div>');
            if (c === "text") {
                d.find("." + a).text(b);
            } else {
                d.find("." + a).html(b);
        ...
        d.find("embed, video, .gp_media_video").remove();
        d.find("picture").each(function() {
            var a = $(this);
            var b = a.find("img").eq(0).clone();
            b.attr("src", b.attr("srcset"));
            a.after(b);
            a.remove();
        });
        d.find("p").filter(function() {
            return this.innerHTML.replace("&nbsp;", " ").trim() == "";
        }).remove();
        (function() {
            var a = d.find("figure").eq(0);
            var b = a.find("img").clone();
            a.after(b);
            a.remove();
        })();
        ...
        pluginTool.read("style", function(a) {
            if ($.isEmptyObject(a)) return;
            var b = $.parseJSON(a.style);
            f(b);
        });
        function f(a) {
            for (var b = 0; b < a.length; b++) {
                var c = a[b], e = d.find(c.selector), f = e.attr("style"), h = c.value;
                e.attr("style", g(f, h));
            }
        }
        function g(a, b) {
            var c = String(a).trim().split(/\s*[:;]\s*/), d = String(b).trim().split(/\s*[:;]\s*/), e = {}, f, g, h = "";
        ...
        $.getJSON("http://77g0kp.com1.z0.glb.clouddn.com/article-style.json?" + Math.random(), function(a) {
            f(a);
        });
        (function() {
            var a = $("#plugin-option-panel"), b = a.find("#footerimg-panel"), c = b.find("#footerimg-option-template");
            pluginTool.read("footerimg", function(a) {
                var e;
                if (!$.isEmptyObject(a.footerimg)) {
                    e = $.parseJSON(a.footerimg);
                } else {
                    e = {};
                }
                for (img in e) {
                    var f = img, g = e[img], h = c.clone();
                    h.removeClass("hide");
                    h.css({
                ...
                b.find(".footerimg-item").hover(function(a) {
                    $(this).siblings(".footerimg-item").addClass("blur");
                }, function() {
                    $(this).siblings().removeClass("blur");
                });
                b.find(".footerimg-item").on("click", function() {
                    var a = $(this).data("imgurl"), b = d.find("#article-footerimg");
                    b.attr("src", a).removeClass("hide").css({
                        width: "100%",
                        "max-width": "100%"
                    });
                    $("html,body").animate({
                        scrollTop: parseInt(b.offset().top - 250) + "px"
                    }, 800);
                });
            });
        })();
        (function() {
            pluginTool.read("codeblock", function(a) {
                if (a.codeblock === undefined) return;
                var b = JSON.parse(a.codeblock);
                for (var c in b) {
                    if (c === "top") {
                        d.prepend(b[c]);
                    }
        ...
        var i = function() {
            var a = $("#plugin-option-panel");
            function b() {
                a.addClass("show");
                a.css("top", 80 + $("#plugin-inject-btn").height() + "px");
            }
            function c() {
                a.removeClass("show");
            }
    ...
    (function() {
        var b = chrome.extension.getURL("click_btn.html");
        $.get(b, function(b) {
            $("body").append(b);
            $("#plugin-post-to-wechat,#plugin-post-to-weibo").on("click", function() {
                ...
                $("#plugin-manage-footerimg").removeClass("hide").on("click", function() {
                    window.open(chrome.extension.getURL("options.html"));
                });
                if (b == "weibo") {
                    $("#plugin-generpic").removeClass("hide");
                    var c = $("#plugin-content");
                    c.css({
                        width: "570px",
                        padding: "15px",
                        "font-size": "25px"
                    ...
                    c.find("img").prop("crossOrigin", "Anonymous");
                }
                $("#plugin-generpic").on("click", function() {
                    var a = document.getElementById("plugin-content");
                    html2canvas(a, {
                        allowTaint: true,
        ...
        var c = ($(document).width() - $(".container").width()) / 2;
        $("#plugin-inject-btn").css("left", c);
    })();
});
...
$(function() {
    ...
    var a = chrome.extension.getURL("click_btn.html");
    $.get(a, function(a) {
        $("body").append(a);
        $("#plugin-inject-btn a").addClass("hide");
        $("#plugin-event").removeClass("hide").on("click", function() {
...
$(function() {
    ...
    var a = function() {
        ...
        function b() {
            ...
            a.find("#add-img-btn").on("click", function(a) {
                a.stopPropagation();
                f();
                e();
                location.reload();
        ...
        function d() {
            a.removeClass("hover");
            a.find("img").removeClass("show");
            a.find(".form").addClass("show");
        }
        function e() {
            a.addClass("hover");
            a.find("img").addClass("show");
            a.find(".form").removeClass("show");
        }
        function f() {
            var a = {};
            a.name = $("#img-name").val();
            a.url = $("#img-url").val();
            pluginTool.add("footerimg", a.name, a.url);
        }
        function g(a) {
            pluginTool.remove("footerimg", a);
        }
        return {
            init: b,
            initDeleteBtn: c
    ...
    a.init();
    (function() {
        var b = $("#pic-item-template");
        pluginTool.read("footerimg", function(c) {
            var d;
            if (!$.isEmptyObject(c.footerimg)) {
                imgs = $.parseJSON(c.footerimg);
            } else {
                imgs = {};
            }
            for (d in imgs) {
                $item = b.clone();
                $item.css({
                    background: "url(" + imgs[d] + ") center center no-repeat",
                    "background-size": "cover"
                });
                $item.find(".des").text(d);
    ...
    (function() {
        var a = $("#article-style");
        pluginTool.read("style", function(b) {
            if (!$.isEmptyObject(b.style)) {
                var c = $.parseJSON(b.style);
                for (var d = 0; d < c.length; d++) {
                    var e = c[d];
                    var f = a.find('li[data-selector="' + e.selector + '"]');
                    f.find("input").val(e.value);
                }
            }
        });
        a.find("#article-style-save").on("click", function() {
            var b = [];
            a.find("#style-form input").each(function() {
                var a = {};
                a.selector = $(this).parents("li").eq(0).data("selector");
                a.value = $(this).val();
                b.push(a);
            });
            var c = JSON.stringify(b);
            pluginTool.save("style", c);
            location.reload();
        });
    })();
    (function() {
        var a = $("#codeblock");
        c();
        a.find("#article-codeblock-save").on("click", function() {
            b();
        });
        function b() {
            var b = {};
            ...
            pluginTool.save("codeblock", JSON.stringify(b));
        }
        function c() {
            pluginTool.read("codeblock", function(b) {
                var c = JSON.parse(b.codeblock);
                for (var d in c) {
                    a.find("textarea[data-type=" + d + "]").val(c[d]);
                }
            });
        }
    })();
